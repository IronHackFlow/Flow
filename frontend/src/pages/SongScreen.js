...
import { playIcon, pauseIcon, previousIcon, forwardIcon, closeIcon } from '../assets/images/_icons'
              ...
              <div className="song-listing-inner">
                ...
                <div className="listing-track-container">
                  ...
                  <div className="track-details-container">
                    ...
                    <p>
                      by:{' '}
                      <span style={{ color: '#b7a2a6' }}>
                        {songInView?.song?.song_user?.user_name}
                      </span>
                    </p>
              ...
              <div className="song-play-outer">
                <div className="play-buttons-container">
                  <div className="play-buttons-left">
                    <button
                      className="play-arrow-container"
