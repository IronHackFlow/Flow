...
const MemoizedItem = memo(
  function EditProfileItem({ inputData, updateList }) {
    const { name, type, placeholder, autoComplete, inputRef, value, setValue, borderRadius } =
      inputData
    ...
    return (
      <li className="edit-section__item">
        <div className="edit-section__item--shadow-outset" style={{ borderRadius: borderRadius }}>
          <label for={name} className="edit-section__item-input-container">
