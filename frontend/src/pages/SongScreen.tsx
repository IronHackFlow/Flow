...
//   returnValue: string,
// }
// // REFACTOR: Will take in a songId and other possible important params.
// // but instead of relying on context. It will use songId to useQuery and cache
// // data for songId ['songs', 'songUser', 'list']
...
//   const { currentSong, returnValue } = state
...
//   const [usersSongs, setUsersSongs] = useState<Array<{song: Song, songVideo: string}>>([])
...
//   const getSongIndex = (array: Array<{song: Song, songVideo: string}>, current: {song: Song, songVideo: string}): number => {
