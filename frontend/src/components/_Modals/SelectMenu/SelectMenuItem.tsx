...
export default function SelectMenuItem({
  ...
  return (
    <li
      id={`${item[listKey[0]]}`}
      ref={hoverRef}
      className={`select-menu__item-container ${
        selected ? 'selected' : isHovered ? 'selected' : ''
      }`}
    ...
    >
      ...
      >
        <LayoutTwo
          classes={[
            'select-menu__item-bullet selected_5',
            'select-menu__item-bullet--shadow-inset selected_6',
          ]}
        >
