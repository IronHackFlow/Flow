...
export const Form = ({ currentSong }: FormProps) => {
  const { handleSaveSong, error, setError } = useSongForm()
      ...
      <form className="song-inputs-container">
        ...
        <div className="buttons-container">
          <div className="buttons-container_shadow-div-inset">
            <button className="save-song-button--submit" type="submit" onClick={(e) => handleSaveSong(e, currentSong, titleRef.current, captionRef.current)}>
              Save
            </button>
          </div>
        </div>
