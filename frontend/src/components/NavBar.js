...
function NavBar(props) {
  ...
  useEffect(() => {
    ...
    if (locationIndicator?.pathname.slice(0, 8) === "/profile") {
      ...
      recordBtnRef2.current.style.boxShadow = "inset 2px 2px 3px 0px #908d8d, inset -2px -2px 3px #ffffff"
            ...
            <div className="navbar-btn-container" 
              ...
              <div className="navbar-btn_shadow-div-inset" ref={searchBtnRef2}>
                <div className="navbar-btn_shadow-div-outset" ref={searchBtnRef3}>
                  <img className="button-icons" src={search} ref={searchBtnRef4} alt="search icon" />
                </div>
              </div>  
