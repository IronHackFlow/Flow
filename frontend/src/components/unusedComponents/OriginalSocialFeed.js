          ...
          <div className="social-list">
            <div className="individual-btn">
              <div className="individual-profile-pic">
                <Link
                  to={{
                    pathname: `/profile/other/${SONG.songUser?._id}`,
                    profInfo: SONG.songUser,
                  }}
                  ref={songRef}
                >
                  <img
                    className="prof-pic"
                    src={SONG.songUser?.picture}
                    ref={profilePicRef}
                    alt=""
                  />
                </Link>
          ...
          <div className="nav-list">
            ...
            <div className="nav-buttons-rim" ref={exploreRim}>
              <div className="nav-buttons-outset" ref={exploreOut}>
                ...
                >
                  <img
                    className="button-icons bi-explore"
                    ref={exploreIcon}
                    src={explore}
                    alt="explore"
                  ></img>
        ...
        return (
          <div className="comment-list">
            <div className="comment-list-inner">
              <p className="comment-username">{writer}</p>
    ...
    <div className="SocialFeed">
      <div ref={windowRef} className="social-panel">
        <CSSTransition
          ...
          timeout={800}
        >
          <ul className="video-scroll-container">{showExploreSongs()}</ul>
        </CSSTransition>
