...
function Home(props) {
  ...
  const postFollow = () => {
    actions
      .addFollow({ followedUser: songUser._id, followDate: new Date() })
      .then(res => {
  ...
  return (
    ...
    >
      <div className="Home">
            ...
            <div className="toggle-feed-container">
              <div className="each-feed_shadow-div-inset">
                <div className="each-feed_shadow-div-outset">
                  <div className="each-feed_shadow-div-inset-2">Feed</div>
                </div>
              </div>

              <div className="each-feed_shadow-div-inset" style={{ borderRadius: '50px' }}>
                <div className="each-feed_shadow-div-outset">
                  <div className="each-feed_shadow-div-inset-2">Trending</div>
                </div>
              </div>
              ...
              >
                <div className="each-feed_shadow-div-outset">
                  <div className="each-feed_shadow-div-inset-2">Following</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="song-data-container">
                <div className="song-user-section">
                  <div className="user-pic-container">
                    <div className="user-pic_shadow-div-outset">
                      <Link
                        to={{
                          pathname: `/profile/${userForSong.songUser?._id}`,
                          profileInfo: userForSong.songUser,
                        }}
                        className="user-pic_shadow-div-inset"
                        onClick={() => setToggleProfile(true)}
                      >
                        <img
                          src={userForSong.songUser?.picture}
                  ...
                  <div className="song-title-container">
                    <div className="song-title_shadow-div-outset">
                      <div className="song-title_shadow-div-inset">
                        <p id="one">
                          {userForSong.songName} <img src={bullet} alt="bullet point" />
                        </p>
                        <p id="two">{userForSong.songUser?.userName}</p>
                      </div>

                      <div className="song-caption-container">
                        <p className="song-date">
                          {dateFormatHandler(userForSong.songDate)}{' '}
                          <img src={bullet} alt="bullet point" />
                        </p>
                        <p className="song-caption">
                          {userForSong.songCaption
                            ? userForSong.songCaption
                ...
                <div className="song-play-section">
                  <div className="play-bar-container">
                    <div className="play-bar_shadow-div-inset"></div>
                  </div>
        ...
        />
        <NavBar searchBtn={searchBtn} profilePicRef={profilePicRef} userForSong={userForSong} />
      </div>
    </TheViewContext.Provider>
  )
}
